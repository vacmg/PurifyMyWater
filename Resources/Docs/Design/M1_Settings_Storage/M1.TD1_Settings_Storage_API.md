...
- **typedef enum  {NO_ERROR = 0, KEY_NOT_FOUND_ERROR, TYPE_MISMATCH_ERROR, KEY_EXISTS_ERROR, CORRUPTED_SETTINGS_FILE_ERROR, MODULE_ALREADY_REGISTERED_ERROR, INVALID_INPUT_ERROR} SettingError_t;**
...
- **public SettingError_t initialize()**
  // Initializes settingsMap, gets & validate data from flash and store it in settingList using SettingsParser Class.
