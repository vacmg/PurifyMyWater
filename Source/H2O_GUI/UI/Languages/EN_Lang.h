...
const char *const pathEN[] PROGMEM = { EN_HelpTopic1_PATH,EN_HelpTopic2_PATH,EN_HelpTopic3_PATH,EN_HelpTopic4_PATH,EN_HelpTopic5_PATH,EN_HelpTopic6_PATH,}; // Follow the same order as enum PathIDs (Languages.h)
