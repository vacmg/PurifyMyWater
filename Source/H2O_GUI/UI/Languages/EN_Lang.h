...
const char EN_UpRangeValue_STR[] PROGMEM = "Value out of range above";
const char EN_LowRangeValue_STR[] PROGMEM = "Value out of range bellow";
...
const char *const langEN[] PROGMEM = {EN_LANG_STR, EN_YES_STR,EN_NO_STR,EN_ON_STR, EN_OFF_STR, EN_Previous_STR, EN_Next_STR,EN_Delete_STR, EN_OK_STR, // Utils
                                      ...
                                      EN_ScreenNotImplementedError_STR,EN_UpRangeValue_STR,EN_LowRangeValue_STR// Error
