...
enum StringIDs{Lang_STR = 0, YES_STR, NO_STR, ON_STR, OFF_STR, Previous_STR, Next_STR, Delete_STR, OK_STR, // Utils
    ...
    ScreenNotImplementedError_STR, UpperBoundError_STR ,InnerBoundError_STR, // Error
};
...
enum PathIDs{HelpTopic1_PATH,HelpTopic2_PATH,HelpTopic3_PATH,HelpTopic4_PATH,HelpTopic5_PATH,HelpTopic6_PATH,ResetPopup_PATH,UpperBoundError_PATH,InnerBoundError_PATH};
