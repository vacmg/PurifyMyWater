...
byte STOPWORKINGTEMP = 65; // in Cº // 0 < STARCASETEMP, STARPSUTEMP < STOPWORKINGTEMP
byte STARTCASETEMP = 40; // in Cº // 0 < STOPCASETEMP < STARCASETEMP
byte STOPCASETEMP = 38; // in Cº // 0 < STOPCASETEMP < STARCASETEMP
